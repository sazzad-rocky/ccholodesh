...
public class LocalTour {
    ...
    @SerializedName("local_tour_group_size")
    @Expose
    ...
    @SerializedName("local_tour_group_cost")
    @Expose
    public String localTourGroupCost;
    @SerializedName("local_tour_details")
    @Expose
    private String localTourDetails;
    @SerializedName("local_tour_group_status")
    @Expose
    ...
    @Expose
    public String placeNameBn;

    @SerializedName("reservation_type_name_bn")
    @Expose
    public String resTypeBn;
